/*
O objetivo é que a função receba um array e retorne ele caso o seu tamanho corresponda ao número enviado com parâmetro na função.
...
console.log(meuArray([1, 2, 3, 4, 5], 5));